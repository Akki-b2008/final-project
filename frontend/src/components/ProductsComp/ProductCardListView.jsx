...
const ProductCardListView = ({
  ...
  return (
    <div className="bg-[#f1f1f1] productCard rounded-md overflow-hidden shadow-md p-4 pb-3 flex gap-5">
      <div className="product-imgWrapper w-[30%] h-[300px] overflow-hidden group relative flex rounded-md ">
        <div className="images overflow-hidden w-full h-full">
      ...
      <div className="flex flex-col gap-2 w-[70%] py-[20px]">
        <Link to={href} className="transition-all">
          <div className="product-info p-3 font-montserrat flex flex-col gap-2">
            ...
            <h3 className="text-[15px] font-[600] hover:text-red-500">
              {productName}
            </h3>

            <p className="text-[16px] font-[500] text-[rgba(0,0,0,0.5)]">
              {description}
            </p>

            <div className="flex gap-4 items-center">
              <p className="text-[16px] font-[600] text-red-500">
                {price}
              </p>
        ...
        <div className="productCard-addToCart p-2 w-fit px-6 flex gap-4 justify-start start-0 items-center border border-red-500 rounded-md text-red-500 cursor-pointer ">
